...
class RestaurantOrderManagement:
    def __init__(self, root):
        ...
        tk.Label(frame, text="Currency:").grid(row=len(self.menu_items) + 1, column=0, padx=10, pady=5)
        ...
        self.currency_var.trace("w", lambda *args: self.update_menu_prices())
    ...
    def place_order(self):
        ...
        if total_cost > 0:
            order_summary += f"Total: {symbol}{total_cost:.2f}"
